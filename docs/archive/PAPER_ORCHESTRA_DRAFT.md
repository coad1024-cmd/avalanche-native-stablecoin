...
5. **On-Chain Yield Recirculation (ACP-67 Alignment):** We integrate liquid staking cash flows into an on-chain value waterfall allocating 65.00% to $AVAX$ buybacks, 20.00% to validator staking supplements, and 15.00% to sovereign Subnet liquidity.
...
flowchart TD
    ...
    Waterfall -->|15% ($0.90M)| Subnet["Sovereign L1 Grants\n• Teleporter Liquidity Seeding"]
```
...
3. **15.00% to Sovereign L1 Liquidity Grants:** Subsidizes cross-L1 Teleporter bridge routing and native Subnet gas tokens.
